...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure statusbarColorClose(Sender: TObject);
...
begin
  ...
  If (ToolBar1.Align = alBottom) then Form4.ComboBox3.Caption:='Bottom';
  If (StatusBar1.Align = alTop) then Form4.ComboBox2.Caption:='Top';
...
begin
  ...
  if (ToolBar1.Align = alBottom) then writeln(config, 'bottom');
  if (ToolBar1.Align = alTop) then writeln(config, 'top');

  if (StatusBar1.Align = alBottom) then writeln(config, 'bottom');
  if (StatusBar1.Align = alTop) then writeln(config, 'top');
...
procedure TForm1.statusbarColorClose(Sender: TObject);
begin
  Form1.StatusBar1.Color:=statusbarColor.Color;
end;
